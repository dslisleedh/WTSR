...
if __name__ == "__main__":
    ...
    # parser.add_argument('--early_stopping', type=int, default=100, help='patient')
    # 
    ...
    # parser.add_argument('--sr_archs', type=str, default='sisr', choices=['sisr', 'misr', 'sisr_swin', 'misr_test'],
    ...
    # 
    # # Realistic SR
    # parser.add_argument('--use_gan', type=bool, default=False, help='use gan')
    # parser.add_argument('--discriminator_filters', type=int, default=8, help='number of filters in discriminator')
    # parser.add_argument('--gan_loss_weight', type=float, default=1e-3, help='gan loss weight')
